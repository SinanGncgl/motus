...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn("px-2 py-1.5 text-[10px] font-mono uppercase tracking-wider text-[#6b7280]", className)}
      {...props}
    />
  )
}
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn("bg-[#2a2a3a] pointer-events-none -mx-1 my-1 h-px", className)}
      {...props}
    />
  )
}
